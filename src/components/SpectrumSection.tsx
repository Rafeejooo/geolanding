...
import { AlertTriangle, Sprout, Waves, Pickaxe, Trees, Building2, ArrowRight } from 'lucide-react';
...
const spectrumCards = [
  {
    ...
    description: 'Satellite monitoring enables early warning systems for floods, wildfires, earthquakes, and other natural disasters to support rapid response.',
    image: 'https://images.unsplash.com/photo-1605727216801-e27ce1d0cc28?w=800&q=80',
    gradientFrom: 'from-cyan-900/40',
  },
  {
    title: 'Oceanography & Fishing',
    icon: Waves,
    borderColor: 'border-blue-500/40',
    iconBg: 'bg-blue-500/20',
    iconColor: 'text-blue-400',
    glowHover: 'hover:border-blue-500/70 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)]',
    description: 'By measuring sea temperatures and monitoring marine ecosystems, satellite imagery supports sustainable fishing and reveals vital insights into ocean health.',
  ...
  },
  {
    ...
    description: 'Assess crop health, monitor field conditions, and optimize land use with multi-spectral satellite data to boost yield and reduce agricultural risk.',
  ...
  },
  {
    ...
    description: 'Track mining activity, detect illegal operations, and monitor environmental impact across extraction sites with high-resolution satellite imagery.',
    ...
    <section className="py-16 md:py-28 relative z-10 bg-[#020204] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-4 drop-shadow-[0_0_20px_rgba(6,182,212,0.5)]">
